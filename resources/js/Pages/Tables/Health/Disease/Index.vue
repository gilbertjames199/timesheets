<template>
    <Head>
        <title>Persons with Health Related Issue & Lifestyle</title>
    </Head>
    ...
    <div class="row gap-10 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>
                ...
                Persons with Health Related Issue & Lifestyle
            </h3>
            <div class="peers">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Availed Medical Treatment</th>
                    ...
                    <tbody>
                        <tr v-for="(person_info, index) in person_infos.data" :key="index">
                            ...
                            <td>
                                <span v-if="person_info.health.health_issues==='Others, specify'">
                                    {{ person_info.health.health_issues_others_specify }}
                                </span>
                                <span v-else>{{ person_info.health.health_issues }}</span>
                            </td>
                            <td>{{ person_info.health.is_smoker }}</td>
                            <td>{{ person_info.health.medical_treatment_past_month }}</td>
                            <td>{{ person_info.health.medical_treatment }}</td>

                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(person_info, index) in person_infos.data" :key="index">
                            ...
                            <td>
                                <span v-if="person_info.work.kind_industry==='Other specify'">
                                    {{ person_info.work.kind_industry_other_specify_value }}
                                </span>
                                <span v-else>{{ person_info.work.kind_industry }}</span>
                            </td>
                            <td>{{ person_info.work.primary_job }}</td>
                            <td>{{ person_info.work.emp_status }}</td>
                            <td>{{ person_info.work.emp_class }}</td>
                            <td>{{ person_info.ins.sss }}</td>
                            <td>{{ person_info.ins.gsis }}</td>

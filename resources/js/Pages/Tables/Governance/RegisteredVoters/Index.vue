                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Address</th>
                            <th>Voted in the Last Regular Election</th>
                            <th>Voted in the Last SK Election</th>
                    ...
                    <tbody>
                        <tr v-for="(person_info, index) in person_infos.data" :key="index">
                            ...
                            <td>{{ person_info.y03v.voted_last_regular_election }}</td>
                            <td>{{ person_info.y03v.voted_last_sk_election }}</td>
                            <td>
                                <tr v-for="item1 in person_info.pos">
                                    <td style="border-bottom-style: dotted; font-size: 90%">
                                        ...
                                        <div v-else>
                                            <span >Position: </span>
                                            <span style='font-style: italic'>{{ item1.position	}}</span>
                                            <br><br>
                                        </div>
                                    </td>
                                </tr>

                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(person_info, index) in person_infos.data" :key="index">
                            ...
                            <td><span v-if="person_info.purok_sitio">Purok {{ person_info.purok_sitio }},</span>
                                {{ person_info.barangay }}</td>
                            <td>{{ person_info.y02.current_grade }}</td>
                            <td>{{ person_info.y02.current_school_address  }}</td>
...
export default {
    ...
    methods: {
        ...
        async loadBarangays(select_mun){
            ...
            this.select_pur =null;
            this.all_barangays=null;
            this.all_puroks=null;
             if(select_mun===""){

<template>
    ...
    <div class="row gap-10 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <div><input type="date" id="birthday" name="Select Date" v-model="date_sel" class="form-control"></div>
            
            <!--<div>{{ person_infos.data }}</div>-->
            <div class="peers">
                <div class="peer mR-10">
                    <select class="form-control">
                        <option selected>demo user</option>
                        <option >demo1 user</option>
                        <option >demo2 user</option>
                    </select>
                </div>
                <div class="peer">
                ...
                <div class="peer">
                    <!--<Link class="btn btn-primary btn-sm" href="/users/create">Add User</Link>-->
                    <button class="btn btn-primary btn-sm mL-2 text-white" @click="showFilter()">Save</button>
                </div>
                <div class="peer">
                    <!--<Link class="btn btn-primary btn-sm" href="/users/create">Add User</Link>-->
                    <button class="btn btn-primary btn-sm mL-2 text-white" @click="showFilter()">Submit</button>
                    &nbsp;&nbsp;
                </div>
                <div class="peer mR-10">
        ...
        <filtering v-if="filter" @closeFilter="filter=false">
            Additional filters appears here
        </filtering>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>
                                ...
                                <div style="font-weight: normal !important;">unbillable labor</div>
                            </th>
                            <th>
                                ...
                            </th>
                            <th>
                                <button class="btn btn btn-secondary btn-sm mL-2 text-white">...</button>
                            </th>
                            <th>
                                <button class="btn btn btn-secondary btn-sm mL-2 text-white">...</button>
                            </th>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <div style="font-weight: normal !important;">Your task name -253</div>
                            </th>
                            <th>
                                ...
                            </th>
